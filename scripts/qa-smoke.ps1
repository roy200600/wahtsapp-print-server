...
Test-TextContains "public\app.js" "/api/updates/status"
Test-TextContains "public\app.js" "renderUpdateRunStatus"
...
Test-TextContains "scripts\print-pdf-profile.ps1" '$ProjectRoot = (Resolve-Path (Join-Path $PSScriptRoot "..")).Path'
...
Test-TextContains "src\maintenance.ts" "getUpdateStatus"
Test-TextContains "src\maintenance.ts" "update-status.json"
Test-TextContains "src\maintenance.ts" "update-latest.log"
Test-TextContains "src\adminServer.ts" "/api/updates/status"
